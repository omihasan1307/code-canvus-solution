...
import logo from "../../../public/code canvas creations/icon.png";
                  ...
                  <ul>
                    ...
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Email Now</span>
                        <h6>
                          <a href="#">chairman.codecanvascreation@gmail.com</a>
                        </h6>
                      </div>
                    </li>
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <h6>104/A East Basabo, Dhaka-1214, Bangladesh</h6>
                      </div>
                    </li>
                  </ul>
                </div>
