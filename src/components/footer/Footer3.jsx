              ...
              <div className="col-lg-4 col-md-8 col-sm-6">
                <div className="footer-widget">
                  ...
                  <div className="content">
                    <p>
                      Welcome to Code Canvus Solutions, where innovation meets
                      our passion in a journey that started with a simple idea
                      and a shared dream.
                    </p>
                  </div>
          ...
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="tel:+880 - 1601 477 401">+880 - 1601 477 401</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
