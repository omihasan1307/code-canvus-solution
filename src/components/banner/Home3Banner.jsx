          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="banner-content">
                ...
                <p>
                  Welcome to Code Canvus Solutions, where digital innovation
                  meets strategic excellence as a dynamic force in the realm of
                  digital marketing, we are dedicated tourat propelling
                  businesses into the spotlight of online success.
                </p>
                <ul>
                  <li>
                    <svg
